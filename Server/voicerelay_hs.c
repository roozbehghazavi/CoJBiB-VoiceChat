...
static const char* g_jsonPath = "players.json";   // override via env PLAYERS_JSON
static const char* g_keyPath  = "relay_key.bin";   // override via env RELAY_KEY_FILE
...
int main(int argc,char**argv){
    ...
    { const char* e;
      if((e=getenv("PLAYERS_JSON"))   && *e) g_jsonPath=e;
      if((e=getenv("RELAY_KEY_FILE")) && *e) g_keyPath=e;
    }
    printf("[relay] players.json=%s  keyfile=%s\n", g_jsonPath, g_keyPath);
    loadOrCreateKeys();
